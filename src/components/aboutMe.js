    ...
    return (
        <div className='about-me'>
            ...
            <div className='about-me-section'>
                ...
                <p className="about-me-introduction">Self taught M(S)ERN stack web developer with a curiosity for Web ML and a passion for creativity! I enjoy helping others achieve their dreams by creating the best possible content for their businesses, even under pressure!  <br /><br />
